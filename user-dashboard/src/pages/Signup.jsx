...
export default function Signup() {
  ...
  const inputStyle = { width: '100%', padding: '10px 12px', background: '#0f172a', border: '1px solid #334155', borderRadius: 6, color: '#e2e8f0', marginBottom: 16, outline: 'none' };
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#0f172a' }}>
      <form onSubmit={handleSubmit} style={{ background: '#1e293b', padding: 32, borderRadius: 12, width: 380, border: '1px solid #334155' }}>
        ...
        <p style={{ color: '#64748b', fontSize: 13, textAlign: 'center', marginBottom: 24 }}>Create your account</p>
        ...
        <input type="password" value={form.confirmPassword} onChange={set('confirmPassword')} required style={inputStyle} />
